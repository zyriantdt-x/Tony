...
{
    [DbContext(typeof(TonyStorage))]
    partial class TonyStorageModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tony.Server.Storage.Entities.NavigatorCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Tony.Server.Storage.Entities.PlayerData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("Tony.Server.Storage.Entities.RoomData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("Tony.Server.Storage.Entities.RoomModel", b =>
                {
            ...
            modelBuilder.Entity("Tony.Server.Storage.Entities.RoomData", b =>
                {
                    b.HasOne("Tony.Server.Storage.Entities.RoomModel", "Model")
                        .WithMany()
                        .HasForeignKey("ModelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Tony.Server.Storage.Entities.PlayerData", "Owner")
                        .WithMany()
