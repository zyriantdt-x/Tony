...
[Header( 64 )]
internal class GetStatusesHandler : IHandler {
    ...
    public GetStatusesHandler( IRoomEntityService entity_service, IRoomDataService room_data, IPlayerService player_data ) {
    ...
    public async Task Handle( ITonyClient client, object message ) {
        ...
        await client.SendAsync( new UserStatusesComposer() {
